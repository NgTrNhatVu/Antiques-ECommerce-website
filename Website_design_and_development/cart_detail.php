                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <textarea name="dia_chi" cols="50" rows="5" required><?= $dia_chi; ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<!--===========================================================  HIỂN THỊ GIỎ HÀNG   ========================================================-->
            ...
            <form action="" method="POST">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <img width="100px" height="100px" src="images/product-picture/<?= $row['hinh_anh']; ?>" alt="hinh-anh-san-pham">
                        </td>
                        <td>
                            <b><?= $row['ten']; ?></b>
                            <br><br>
                            <input type="number" name="amount[<?= $row['id']; ?>]" 
                            value="<?= $_SESSION['quantity'][$row['id']];?>"><!--Số lượng từng sản phẩm-->
                        </td>
                        <td>
                            <?= number_format($row['gia'] * $_SESSION['quantity'][$row['id']], 0, ',', '.');?>đ
                        </td> <!--Thành tiền -->
                    </tr>
                <?php    
                ...
                ?>
                    ...
                    <h4>Tổng tiền: <?= number_format($total_price, 0, ',', '.'); ?> VNĐ</h4>
