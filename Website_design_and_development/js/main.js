...
function slideSignUp() {
  ...
  slideMessage[0].innerHTML =
    "<h2>Chào mừng bạn đến với BKC Antiques and Auctions!</h2><br>" +
    "<p>Để mua hàng cũng như sớm nhận được những thông báo vầ các đợt khuyến mại của " +
    "BKC Antiques and Auctions, hãy đăng kí bằng tài khoản bằng thông tin của bạn</p><br><br>" +
...
function slideSignIn() {
  ...
  slideMessage[0].innerHTML =
    ...
    "BKC Antiques and Auctions, hãy đăng nhập bằng thông tin tài khoản và mật khẩu ở form đăng nhập bên cạnh</p><br><br>" +
