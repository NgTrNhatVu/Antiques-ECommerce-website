...
<!--================================================= TOP HEADER  =======================================================================-->
    <div id="top-header">
        <div class="container">
            <ul id="header-links">
                <li><i class="fas fa-phone"></i>+84 055 555 555</li>
            ...
            <div class="container">
                ...
                <form class="search-bar" action="find.php" method="GET">
                    ...
                    <div class="search-brand">
                        <select name="brand">
                            <option value="">Mọi xuất xứ</option>
                            <?php 
            ...
            <ul class="nav-links">
                <div class="container">
                    ...
                    <?php 
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <li><a href="find.php?cat=<?= $row['id']; ?>"><?= ucwords($row['ten_danh_muc']); ?></a>
                            <ul class="sub-menu">
                            <?php
                                $innerSql = "SELECT * FROM danh_muc WHERE parent_id = " . $row['id'];
                                $innerResult = mysqli_query($connect, $innerSql);
                                while ($innerRow = mysqli_fetch_assoc($innerResult)) {
                            ?>
                                <li>
                                    <a href="find.php?cat=<?php echo $innerRow['id']; ?>">
                                        <?php echo ucwords($innerRow['ten_danh_muc']); ?>
                                    </a>
                                </li>
                            <?php
                                }
                    ...
                    <li><a href="event.php">Sự kiện đấu giá</a></li>
