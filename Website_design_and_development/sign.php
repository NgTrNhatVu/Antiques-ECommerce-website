...
<body style="background-color: #f3cf7a;">
    ...
    <?php
        if(isset($_POST['sign-up-btn'])){
            ...
            $password = md5($_POST['sign_up_password']);
            if($password != md5($_POST['check_password'])){
            ...
            <div class="curtain">
                <div class="sign-message">
                    ...
                    <p>
                        ...
                        mại mới nhất của
                        BKC Antiques and Auctions, hãy đăng nhập bằng thông tin tài khoản và mật khẩu ở form đăng nhập bên cạnh
                    </p>
                    <br>
                    <br>
